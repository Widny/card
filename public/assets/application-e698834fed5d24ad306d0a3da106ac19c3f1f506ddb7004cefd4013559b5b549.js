...
$('form').card({
	...
	// formSelectors: {
 //        card_numberInput: 'input#card_number', // optional — default input[name="number"]
 //        exp_dateInput: 'input#exp_date', // optional — default input[name="expiry"]
 //        cvvInput: 'input#cvv', // optional — default input[name="cvc"]
 //        amountInput: 'input#amount' // optional - defaults input[name="name"]
 //    },
